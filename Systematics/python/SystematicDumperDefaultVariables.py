minimalVariables = ["CMS_hgg_mass[110,65,120]:=diPhoton().mass",
...
minimalHistograms = ["CMS_hgg_mass>>mass(110,65,120)"]
		     #"subleadPtMgg:leadPtMgg>>ptMggLeadvsSub(100,0,1:100,0,1)"]

minimalNonSignalVariables = ["CMS_hgg_mass[110,65,120]:=diPhoton().mass"]
			#     "leadPtMgg[100,0,1]:=diPhoton().leadingPhoton.pt/diPhoton().mass",
			#     "subleadPtMgg[100,0,1]:=diPhoton().subLeadingPhoton.pt/diPhoton().mass"]#,"centralObjectWeight[1,-999999.,999999.] := centralWeight"]

defaultVariables=["CMS_hgg_mass[110,65,120]:=diPhoton().mass", 
...
defaultHistograms=["CMS_hgg_mass>>mass(110,65,120)",
...
systematicVariables=["CMS_hgg_mass[110,65,120]:=diPhoton().mass"]#,"centralObjectWeight[1,-999999.,999999.] := centralWeight"]
systematicHistograms=["CMS_hgg_mass>>mass(110,65,120)"]
